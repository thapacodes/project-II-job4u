            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown my-2 my-md-0">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ env('APP_URL') }}/top-job-searches">Top Job Searches</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        ...
                        <li><a class="dropdown-item" href="{{ env('APP_URL') }}/learning-portal">Learning Portal</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown my-2 my-md-0">
                    <a class="nav-link dropdown-toggle text-black fw-500 fs-45" href="#" id="navbarDropdown" role="button"
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ env('APP_URL') }}/why-choose-job4u">Why Choose Job4u ?</a></li>
                ...
                <li class="nav-item"">
                    <a href="{{ env('APP_URL') }}/post-a-job" class="btn btn-danger text-white">Post a job</a>
                </li>
            </ul>
        </div>
    </div>
